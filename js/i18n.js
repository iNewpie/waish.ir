/* ============================================================
   I18N — English / Persian toggle for the whole site.
   - default: English. Choice saved in localStorage ('waish-lang').
   - I18N.t('English text') → Persian when active (else unchanged).
   - On load it translates every text node + placeholder/title/alt/
     data-type attribute it knows, and keeps watching the DOM so
     dynamically rendered content (cards, windows, terminal) follows.
   - Persian mode sets <html lang="fa" dir="rtl">; the terminal
     stays left-to-right (its Persian lines handle themselves).
   Add strings to FA below: exact English text → Persian.
   ============================================================ */
window.I18N = (function () {
  const FA = {
    ...
    'the Discord server + the waish bot': 'سرور دیسکورد + بات ویش', 'full profile: skin, Hypixel, guild, blacklists': 'پروفایل کامل: اسکین، هایپیکسل، گیلد، بلک‌لیست‌ها', 'opened': 'باز شد', 'opening': 'در حال باز کردن', 'online': 'آنلاین', 'members': 'عضو', 'join': 'عضویت', 'bot': 'بات', 'the same commands as here, as slash commands in Discord:': 'همین دستورها، به‌صورت اسلش‌کامند توی دیسکورد:', 'add it to your server, or to your own account to use it anywhere:': 'به سرورت اضافه‌ش کن، یا به اکانت خودت تا همه‌جا کار کنه:',
    ...
    'Donate — Waish': 'حمایت — ویش', 'Donate.': 'حمایت.', '// support': '// حمایت', 'If my projects or videos helped you, you can support the work here.': 'اگه پروژه‌ها یا ویدیوهام بهت کمک کردن، می‌تونی اینجا از کار حمایت کنی.', '// Donation links are coming soon.': '// لینک‌های حمایت به‌زودی.', 'Buy me a coffee — every cup goes back into the servers, the videos and the tools on this site.': 'یه قهوه مهمونم کن — هر فنجون برمی‌گرده به سرورها، ویدیوها و ابزارهای این سایت.', '☕ Support on Coffeebede ↗': '☕ حمایت در کافی‌بده ↗', '// coffee': '// قهوه', '// also': '// همچنین', 'Not in a position to donate? Joining the community and sharing the videos helps just as much.': 'نمی‌تونی حمایت مالی کنی؟ پیوستن به کامیونیتی و به اشتراک گذاشتن ویدیوها همون‌قدر کمک می‌کنه.',
    ...
    'Every creator, streamer and shop in Iran puts the same handful of links in every bio — Instagram, Telegram, Discord, YouTube — and most link-in-bio tools are blocked, slow, or want a foreign card. wbio.ir gives you': 'هر کریتور، استریمر و فروشگاهی توی ایران همون چند تا لینک رو توی هر بایویی می‌ذاره — اینستاگرام، تلگرام، دیسکورد، یوتیوب — و بیشتر ابزارهای لینک بایو یا فیلترن، یا کندن، یا کارت خارجی می‌خوان. wbio.ir بهت می‌ده',
    ': one fast page that opens everywhere, with Persian as the first language, not an afterthought.': ': یه صفحهٔ سریع که همه‌جا باز می‌شه، با فارسی به‌عنوان زبان اول، نه چیزی که آخر کار بهش اضافه شده باشه.',
    'An avatar, a bio, links and social icons in a minute. Then it grows with you: 20 themes with their own layouts, colours and fonts, GIF avatars and backgrounds, 23 effects, a music player, a custom badge, and': 'آواتار، بایو، لینک‌ها و آیکون‌های سوشال توی یه دقیقه. بعد همراهت بزرگ می‌شه: ۲۰ تم با چیدمان، رنگ و فونت خودشون، آواتار و پس‌زمینهٔ گیف، ۲۳ افکت، موزیک‌پلیر، بج اختصاصی و',
    'live cards': 'کارت‌های زنده',
    'that pull your Valorant rank, Minecraft server status or Discord presence onto the page. Analytics show views and clicks per link, and referral codes pay out for the friends you bring.': 'که رنک والورانت، وضعیت سرور ماینکرفت یا وضعیت دیسکوردت رو میارن روی صفحه. آمار، بازدیدها و کلیک‌های هر لینک رو نشون می‌ده، و کد معرف برای هر دوستی که میاری پاداش می‌ده.',
    'On the Enterprise plan the page lives on': 'توی پلن Enterprise صفحه‌ت روی',
    '. You add one DNS record — directly or through ArvanCloud or Cloudflare — and wbio handles the certificate and the routing. No Cloudflare for SaaS, no international card: the domain lands on my own origin, which hands it to the worker.': ' بالا میاد. فقط یه رکورد DNS اضافه می‌کنی — مستقیم یا از طریق ابرآروان یا کلادفلر — و گواهی SSL و مسیریابی رو خود wbio انجام می‌ده. بدون Cloudflare for SaaS و بدون کارت خارجی: دامنه روی سرور خودم می‌شینه و اون به ورکر تحویلش می‌ده.',
    'A single Cloudflare Worker with a Durable Object (SQLite) for users, pages, files and analytics — zero servers to babysit and no running cost until it earns. Passwordless sign-in by email code, Discord or GitHub; payments through Zarinpal; every response hardened with a strict CSP. The dashboard is a live editor: what you change shows in the phone preview before you save.': 'یه Cloudflare Worker تنها با یه Durable Object (SQLite) برای کاربرها، صفحه‌ها، فایل‌ها و آمار — هیچ سروری که بخوای مراقبش باشی، و تا وقتی درآمد نداره هزینه‌ای هم نداره. ورود بدون رمز با کد ایمیل، دیسکورد یا گیت‌هاب؛ پرداخت با زرین‌پال؛ و همهٔ پاسخ‌ها با یه CSP سخت‌گیرانه محافظت می‌شن. داشبورد یه ویرایشگر زنده‌ست: هر تغییری بدی، قبل از ذخیره توی پیش‌نمایش گوشی دیده می‌شه.',
    'plans': 'پلن‌ها', 'bio-link pages · SaaS': 'صفحهٔ لینک بایو · SaaS', 'Free · Plus · Pro · Enterprise': 'رایگان · Plus · Pro · Enterprise',
    'Cloudflare Workers · Durable Objects · Zarinpal': 'Cloudflare Workers · Durable Objects · زرین‌پال', 'my page — wbio.ir/waish': 'صفحهٔ من — wbio.ir/waish',
    ...
    'green': 'سبز', 'dot maximizes': 'نقطهٔ سبز بزرگ می‌کنه', 'apps': 'برنامه‌ها', 'Pinned': 'پین‌شده', 'All apps': 'همهٔ برنامه‌ها', 'Recommended': 'پیشنهادی', 'Back': 'برگشت', 'Search apps and pages…': 'جستجوی برنامه‌ها و صفحه‌ها…', 'No results': 'چیزی پیدا نشد', 'Restart': 'ری‌استارت', 'Shut down': 'خاموش', 'Home page': 'صفحهٔ اصلی', 'Projects page': 'صفحهٔ پروژه‌ها', 'About me page': 'صفحهٔ درباره‌م', 'Contact page': 'صفحهٔ تماس', 'just now': 'همین الان', 'min ago': 'دقیقه پیش', 'h ago': 'ساعت پیش', 'd ago': 'روز پیش', 'page': 'صفحه', 'close': 'بستن', 'minimize': 'کوچک کردن', 'maximize': 'بزرگ کردن', 'Terminal': 'ترمینال', 'YouTube': 'یوتیوب', 'Social': 'شبکه‌های اجتماعی', 'youtube · instagram · telegram · discord': 'یوتیوب · اینستاگرام · تلگرام · دیسکورد', 'Aparat': 'آپارات', 'LunaMC': 'لونا ام‌سی', 'ClutchPing': 'کلاچ‌پینگ', 'NairoShop': 'نایروشاپ', 'This PC': 'این کامپیوتر', 'Snake': 'مار', 'Tetris': 'تتریس', 'Mini Minecraft': 'مینی ماینکرفت', 'Calculator': 'ماشین‌حساب', 'Calendar': 'تقویم', 'User Lookup': 'جستجوی کاربر', 'Skin Lookup': 'جستجوی اسکین', 'Skin Editor': 'ویرایشگر اسکین', 'paint & preview skins': 'نقاشی و پیش‌نمایش اسکین', 'Minecraft · Seraph · Bordic': 'ماینکرفت · Seraph · Bordic', 'Games': 'بازی‌ها', 'build & mine': 'بساز و حفاری کن', 'Persian · Gregorian': 'شمسی · میلادی',
    ...
    'waish@computer · tap an app': 'waish@computer · روی یه برنامه بزن', 'Recycle Bin': 'سطل بازیافت',  'Music': 'موزیک', 'All projects': 'همهٔ پروژه‌ها', 'Restore': 'بازگردانی', 'Restore all': 'بازگردانی همه', 'Empty Recycle Bin': 'خالی کردن سطل', 'Move to Recycle Bin': 'انتقال به سطل بازیافت', 'Open': 'باز کردن', 'Recycle Bin is empty.': 'سطل بازیافت خالیه.', 'Drag a desktop icon onto the bin, or right-click it, to put it here. Refreshing the page brings everything back.': 'یه آیکون دسکتاپ رو بکش روی سطل، یا روش راست‌کلیک کن، تا بیاد اینجا. با رفرش صفحه همه‌چیز برمی‌گرده.',
    'is a Minecraft player blacklisted? (Seraph + Urchin)': 'یه بازیکن ماینکرفت بلک‌لیسته؟ (Seraph + Urchin)', 'Usage:': 'طرز استفاده:', 'checking': 'در حال بررسی', 'Player not found:': 'بازیکن پیدا نشد:', 'Could not resolve the player': 'نشد بازیکن رو پیدا کرد', 'player': 'بازیکن', 'check failed': 'بررسی ناموفق', 'BLACKLISTED': 'بلک‌لیست شده', 'verified': 'تأییدشده', 'bot account': 'اکانت بات', 'not blacklisted': 'بلک‌لیست نیست', 'not configured on this proxy': 'روی این پروکسی تنظیم نشده', 'Full profile:': 'پروفایل کامل:',
