...
window.WAISH_DB = {
  ...
  entries: [
    ...
    },
    {
      ...
      answer: {
        en: ["On this computer: Terminal (me) · This PC (files) · Projects folder (LunaMC, ClutchPing, NairoShop) · Social · About me · Music 🎵 · Snake 🐍 · Tetris 🧱 · Mini Minecraft ⛏️ · Calculator · Calendar (Jalali + Gregorian) · User Lookup 🔍 (Minecraft skins, Hypixel stats, guilds, Seraph, Urchin) · Recycle Bin. Click an icon, use the start menu, or type /open <name> — /apps lists the ids.", "Click any desktop icon, or type /open music, /open snake, /open userlookup, /open calendar… /apps shows every id. The start menu at the bottom-left has them all too."],
        fa: ["روی این کامپیوتر: ترمینال (من) · This PC (فایل‌ها) · پوشهٔ پروژه‌ها (لونا ام‌سی، کلاچ‌پینگ، نایروشاپ) · Social · درباره من · موزیک 🎵 · Snake 🐍 · Tetris 🧱 · ماینکرفت کوچیک ⛏️ · ماشین‌حساب · تقویم (شمسی + میلادی) · User Lookup 🔍 (اسکین ماینکرفت، آمار هایپیکسل، گیلد، Seraph، Urchin) · سطل بازیافت. روی آیکون کلیک کن، از منوی استارت استفاده کن، یا بنویس /open <name> — /apps آیدی‌ها رو نشون می‌ده.", "روی هر آیکون دسکتاپ کلیک کن، یا بنویس /open music، /open snake، /open userlookup، /open calendar… /apps همهٔ آیدی‌ها رو نشون می‌ده. منوی استارت پایین هم همه رو داره."],
      },
    },
    {
    ...
    },
    {
      ...
      answer: {
        en: ["User Lookup (🔍, or /open userlookup) takes a Minecraft username or UUID and shows: the skin in 3D (drag to rotate), model type, cape, UUID; Hypixel rank, network level, BedWars / SkyWars / Duels stats from Bordic's cache; the player's guild and its tag; and whether Seraph or Urchin has them blacklisted. Three tabs: User Lookup, Skin Lookup (upload your own PNG and preview it), Guild Lookup (by guild name or player).", "Type a name → skin, stats, guild, blacklist status, all in one window. Data sources: Mojang for names/skins/capes, Bordic for Hypixel stats, NetherAPI for guilds, Seraph and Urchin for the blacklists. Waish is on the Seraph council, so that part matters to him."],
        fa: ["User Lookup (🔍، یا /open userlookup) یه یوزرنیم یا UUID ماینکرفت می‌گیره و نشون می‌ده: اسکین سه‌بعدی (بکش تا بچرخه)، نوع مدل، شنل، UUID؛ رنک هایپیکسل، لول شبکه، آمار بدوارز / اسکای‌وارز / دوئل از کش Bordic؛ گیلد بازیکن و تگش؛ و اینکه Seraph یا Urchin بلک‌لیستش کرده یا نه. سه تا تب: User Lookup، Skin Lookup (PNG خودت رو آپلود کن و ببین)، Guild Lookup (با اسم گیلد یا بازیکن).", "یه اسم بنویس → اسکین، آمار، گیلد، وضعیت بلک‌لیست، همه توی یه پنجره. منابع: Mojang برای اسم/اسکین/شنل، Bordic برای آمار هایپیکسل، NetherAPI برای گیلد، Seraph و Urchin برای بلک‌لیست. ویش عضو شورای Seraph هست، برای همین اون بخش براش مهمه."],
      },
