...
window.WAISH_DB = {
  ...
  entries: [
    ...
    /* ---------- the computer (desktop simulator) ---------- */
    {
      ...
      answer: {
        en: ["This is a desktop simulator built into the site — not Windows, not Linux, just JavaScript. Icons open apps in draggable windows; the taskbar shows what's running; the start menu (bottom-left) lists every app and the site pages. Single-click everything.", "A fake little OS in your browser. Apps: Terminal (me), This PC, Projects folder, Social, About me, Music, a Games folder (Snake, Tetris, Mini Minecraft), Calculator, Calendar, User Lookup and a Recycle Bin. Windows can be dragged, resized, minimized and maximized — drag one to the top edge for fullscreen."],
        fa: ["این یه شبیه‌ساز دسکتاپه که توی سایت ساخته شده — نه ویندوز، نه لینوکس، فقط جاوااسکریپت. آیکون‌ها برنامه‌ها رو توی پنجره‌های قابل جابه‌جایی باز می‌کنن؛ تسک‌بار برنامه‌های در حال اجرا رو نشون می‌ده؛ منوی استارت (پایین) همهٔ برنامه‌ها و صفحه‌های سایت رو لیست می‌کنه. یه کلیک کافیه، دابل‌کلیک لازم نیست.", "یه سیستم‌عامل کوچیک تقلبی توی مرورگرت. برنامه‌ها: ترمینال (من)، This PC، پوشهٔ پروژه‌ها، Social، درباره من، موزیک، پوشهٔ بازی‌ها (Snake، Tetris، ماینکرفت کوچیک)، ماشین‌حساب، تقویم، User Lookup و سطل بازیافت. پنجره‌ها رو می‌شه کشید، تغییر اندازه داد، کوچیک و بزرگ کرد — یه پنجره رو تا لبهٔ بالا بکش تا تمام‌صفحه بشه."],
      },
    ...
    },
    {
      ...
      keywords: { en: ['projects folder', 'folder', 'the folder', 'where are the projects', 'where is lunamc icon', 'lunamc icon', 'clutchping icon', 'open projects', 'projects icon', 'all projects'], fa: ['پوشه پروژه‌ها', 'پوشهٔ پروژه‌ها', 'پوشه', 'فولدر', 'پروژه‌ها کجان', 'پروژه ها کجان', 'آیکون لونا', 'آیکون کلاچ‌پینگ', 'باز کردن پروژه‌ها', 'آیکون پروژه‌ها', 'همه پروژه‌ها', 'همهٔ پروژه‌ها'] },
      answer: {
        en: ["The yellow Projects folder on the desktop holds LunaMC, ClutchPing and \"All projects\" (the full projects page). Click the folder, then click one. From here you can also type /open lunamc, /open clutchping or /open projects.", "Project icons live inside the Projects folder to keep the desktop clean. Open it → pick LunaMC, ClutchPing or All projects."],
        fa: ["پوشهٔ زرد «پروژه‌ها» روی دسکتاپ لونا ام‌سی، کلاچ‌پینگ و «همهٔ پروژه‌ها» (صفحهٔ کامل پروژه‌ها) رو داره. روی پوشه کلیک کن، بعد روی یکی. از اینجا هم می‌تونی بنویسی /open lunamc، /open clutchping یا /open projects.", "آیکون پروژه‌ها توی پوشهٔ پروژه‌هان تا دسکتاپ تمیز بمونه. بازش کن → لونا ام‌سی، کلاچ‌پینگ یا همهٔ پروژه‌ها رو انتخاب کن."],
      },
    },
    {
